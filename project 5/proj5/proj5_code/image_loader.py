...
class ImageLoader(data.Dataset):
    ...
    def load_imagepaths_with_labels(
        ...
        for cl in class_labels:
            for img in glob.glob(self.curr_folder + "/" + cl + "/*"):
                img_paths.append((img, class_labels[cl]))
        #######################################################################
        # Student code ends
        #######################################################################
        return img_paths
    ...
    def get_classes(self) -> Dict[str, int]:
        ...
        classes['forest'] = 2
        classes['highway'] = 3
        classes['industrial'] = 4
        classes['insidecity'] = 5
        classes['kitchen'] = 6
        classes['livingroom'] = 7
        classes['mountain'] = 8
        classes['office'] = 9
        classes['opencountry'] = 10
        classes['store'] = 11
        classes['street'] = 12
        classes['suburb'] = 13
        classes['tallbuilding'] = 14
